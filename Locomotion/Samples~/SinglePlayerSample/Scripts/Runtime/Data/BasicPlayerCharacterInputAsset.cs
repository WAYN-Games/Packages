...
namespace WAYN.Locomotion.Demo.BasicLocomotion
{
    ...
    [CreateAssetMenu(fileName = "BasicCharacterProfileAsset",
        menuName = "WAYN Games/Locomotion/BasicLocomotion/Player Input Asset", order = 1)]
    public class BasicPlayerCharacterInputAsset : PlayerInputAsset<BasicLocomotionInput>
    {
        ...
        public override void InitInputAsset(PlayerGameObjectInstance playerGameObjectInstance)
        {
            ...
            m_PlayerCamera = playerGameObjectInstance.Instance.Value.GetComponent<PlayerGoAuthoring>().Camera;
        }
    }
}