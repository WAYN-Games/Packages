...
public class StateMachineSourceGenerator : IIncrementalGenerator
{
    ...
    const string Namespace = "WAYNGames.Locomotion.Runtime.StateMachine";
    ...
    {{
        ...
        {{
            m_UninitializedPlayerQuery = new EntityQueryBuilder(Allocator.Temp)
                .WithAll<LocomotionInputAsset<{inputName}>>()
                .WithAll<PlayerGameObjectInstance>()
                .WithNone<LocomotionInputInstance<{inputName}>>()
                .Build(ref state);
            
            m_DestroyedPlayerQuery = new EntityQueryBuilder(Allocator.Temp)
                .WithAll<LocomotionInputInstance<{inputName}>>()
                .WithNone<LocomotionInputAsset<{inputName}>>()
                .Build(ref state);
        }}
        ...
        {{
            ...
            {{
                var inputAsset = state.EntityManager.GetComponentData<LocomotionInputAsset<{inputName}>>(entity);
                ...
                state.EntityManager.AddComponentData(entity, new LocomotionInputInstance<{inputName}>
                {{
            ...
            {{
                var instance = state.EntityManager.GetComponentData<LocomotionInputInstance<{inputName}>>(entity).Instance;
                Object.Destroy(instance);
                state.EntityManager.RemoveComponent<LocomotionInputInstance<{inputName}>>(entity);
            }}
...
{{
    ...
    {{
        ...
        {{
            ...
            {{
                var inputs = state.EntityManager.GetComponentData<LocomotionInputInstance<{inputName}>>(player);
        ...
        {{
            ...
            {{
                ...
                {{
                    ...
                    {{
                        {inputName} input = LocomotionInputLookup[controlledCharacter.Locomotor.Entity];
...
[assembly: RegisterGenericComponentType(typeof(LocomotionInputAsset<{inputName}>))]
[assembly: RegisterGenericComponentType(typeof(LocomotionInputInstance<{inputName}>))]
